      ...
      >
        ...
        <div class="tab_content_wrap">
          <div class="tab_content_header">
            ...
            <div :class="['tab_content_wrap_header_item', { 'active': showCronjobDialog }]">
              <span title="计划任务管理" @click="() => (showCronjobDialog = !showCronjobDialog)">
        ...
        <el-dialog
          v-model="showCronjobDialog"
          align-center
          :title="`计划任务管理-${ item.name }`"
          :width="isMobileScreen ? '100vw' : '85vw'"
          :style="isMobileScreen ? 'max-width: 100vw;' : 'max-width: 1400px;'"
          :close-on-click-modal="false"
        >
          <Cronjob :host-id="item.id" :visible="showCronjobDialog" />
        </el-dialog>
      </el-tab-pane>
    </el-tabs>
...
import { ArrowDown, VideoPause, Setting, Timer } from '@element-plus/icons-vue'
...
import Cronjob from './cronjob.vue'
