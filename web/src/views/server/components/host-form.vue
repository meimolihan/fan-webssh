  ...
  >
    ...
    >
      <el-form-item key="connectType" label="连接类型" prop="connectType">
        <el-radio-group v-model="hostForm.connectType">
          ...
          <el-radio value="rdp">RDP <svg-icon name="icon-Windows" class="icon" /></el-radio>
        </el-radio-group>
      </el-form-item>
      ...
      <el-collapse v-model="advancedSettingsCollapsed" accordion>
        <el-collapse-item name="advanced" title="其他设置">
          <el-form-item
            ...
            prop="proxyType"
          >
            <el-radio-group v-model="hostForm.proxyType">
    ...
    <template #footer>
      <span class="dialog-footer">
        ...
        <el-button v-else type="primary" @click="handleSave">确认</el-button>
      </span>
    </template>
  </el-dialog>
</template>
