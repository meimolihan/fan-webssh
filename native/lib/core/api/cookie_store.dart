...
/// Persists the Fan-WebSSH `session` cookie in secure storage and rehydrates
/// it on every request. The cookie is the second half of Fan-WebSSH's auth
...
class SessionCookieStore {
  ...
  /// Other cookies are ignored; Fan-WebSSH does not use them.
